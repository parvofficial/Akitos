...
class antipinginv(Cog):
    ...
    async def on_message(self, message):
      button = Button(emoji="<:jk_inv:1051073323284561940>",label="Invite", url =  "https://discord.com/api/oauth2/authorize?client_id=1173097825614180463&permissions=8&scope=bot")
      button1 = Button(emoji="<:jk_support:1051073711463211068>",label="Support", url = "https://discord.gg/")
      try:
        ...
        with open('ignore.json', 'r') as heck:
          ...
          if message.mention_everyone:
            ...
            if str(message.channel.id) in randi["ids"]:
              ...
              embed.set_author(name="Akito", icon_url=self.client.user.display_avatar.url)
