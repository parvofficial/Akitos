...
class Join(commands.Cog):
    ...
    async def on_guild_join(self, guild):
         ...
         # data['backupkey'] = key
          ...
          embed = discord.Embed(
            description="Thank you for adding me to your server!\n・ My default prefix is `.`\n・ You can use the `.help` command to get list of commands\n・ Our [Support Server](https://discord.gg/) or our team offers detailed information & guides for commands\n・ Feel free to join our [Support Server](https://discord.gg/) if you need help/support for anything related to the bot",
            color=0x0d0d13
          )
          skidgod = Button(label='Support Server', style=discord.ButtonStyle.link, url='https://discord.gg/')
          #web = Button(label='Website', style=discord.ButtonStyle.link, url='https://discord.gg/3YmDAzbuRR')
          docs = Button(label='Invite Me',style=discord.ButtonStyle.link,url='https://discord.com/api/oauth2/authorize?client_id=1173097825614180463&permissions=8&scope=bot')

          #docs1 = Button(label='Vote Me',style=discord.ButtonStyle.link,url='https://discord.gg/9mHvX3Ra4e')
