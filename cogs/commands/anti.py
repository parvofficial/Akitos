...
class Security(Cog):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if data == "on":
                embed = discord.Embed(
                    title="Akito",
                    description=
                    f"**{ctx.guild.name} security settings **<:role:1173265510331338772>\nOhh uh! looks like your server has already enabled security\n\nCurrent Status: <:Off_off:1173265464311427083><:On_on:1173265433885941873>\n\n> To disable use `antinuke disable`",
                    color=0x2f3136)
                ...
                embed2 = discord.Embed(
                    title="Akito",
                    description=
                    f"**{ctx.guild.name} Security Settings** <:role:1173265510331338772>\nAlso move my role to top of roles for me to work properly.\n\nPunishments:\n\n**Anti Bot:** <:Off_off:1173265464311427083><:On_on:1173265433885941873>\n**Anti Ban:** <:Off_off:1173265464311427083><:On_on:1173265433885941873>\n**Anti Kick:** <:Off_off:1173265464311427083><:On_on:1173265433885941873>\n**Anti Prune:** <:Off_off:1173265464311427083><:On_on:1173265433885941873>\n**Anti Channel Create/Delete/Update:** <:Off_off:1173265464311427083><:On_on:1173265433885941873>\n**Anti Role Create/Delete/Update:** <:Off_off:1173265464311427083><:On_on:1173265433885941873>\n**Anti Webhook Create:** <:Off_off:1173265464311427083><:On_on:1173265433885941873>\n**Anti Emoji Create/Delete/Update:** <:Off_off:1173265464311427083><:On_on:1173265433885941873>\n**Anti Guild Update:**<:Off_off:1173265464311427083><:On_on:1173265433885941873>\n**Anti Community Spam:** <:Off_off:1173265464311427083><:On_on:1173265433885941873>\n**Anti Integration Create:** <:Off_off:1173265464311427083><:On_on:1173265433885941873>\n**Anti Everyone/Here/Role Mention:** <:Off_off:1173265464311427083><:On_on:1173265433885941873>\n**Whitelisted Users:** {len(wled)}\n\n**Auto Recovery:** <:Off_off:1173265464311427083><:On_on:1173265433885941873>",
                    color=0x2f3136)
                embed2.add_field(
                    name="Other Settings",
                    value=
    ...
    async def antinuke_show(self, ctx: Context):
        ...
        if data == "off":
            ...
            embed2 = discord.Embed(
                title="Akito",
                description=
                f"**{ctx.guild.name} security settings** <:role:1173265510331338772>\nPunishments:\n**Anti Bot:** <:Off_off:1173265464311427083><:On_on:1173265433885941873>\n**Anti Ban:** <:Off_off:1173265464311427083><:On_on:1173265433885941873>\n**Anti Kick:** <:Off_off:1173265464311427083><:On_on:1173265433885941873>\n**Anti Prune:** <:Off_off:1173265464311427083><:On_on:1173265433885941873>\n**Anti Channel Create/Delete/Update:** <:Off_off:1173265464311427083><:On_on:1173265433885941873>\n**Anti Role Create/Delete/Update:** <:Off_off:1173265464311427083><:On_on:1173265433885941873>\n**Anti Webhook Create:** <:Off_off:1173265464311427083><:On_on:1173265433885941873>\n**Anti Emoji Create/Delete/Update:** <:Off_off:1173265464311427083><:On_on:1173265433885941873>\n**Anti Guild Update:** <:Off_off:1173265464311427083><:On_on:1173265433885941873>\n**Anti Community Spam:** <:Off_off:1173265464311427083><:On_on:1173265433885941873>\n**Anti Integration Create:** <:Off_off:1173265464311427083><:On_on:1173265433885941873>\n**Anti Everyone/Here/Role Mention:** <:Off_off:1173265464311427083><:On_on:1173265433885941873>\n**Anti Vanity Steal:** <:Off_off:1173265464311427083><:On_on:1173265433885941873>\n**Whitelisted Role:** <@&{wlrole}>\n**Whitelisted Users:** {len(wled)}\n\n**Auto Recovery:** <:Off_off:1173265464311427083><:On_on:1173265433885941873>",
                color=0x2f3136)
            embed2.add_field(
                name="Other Settings",
                value=
    ...
    async def _recover(self, ctx: Context):
        ...
        hacker5 = discord.Embed(
            title="Akito",
            description=
            "<a:cx_tick:1173190431295676416> | Successfully Deleted All Channels With Name Of `rules` and `moderator-only`",
            color=0x2f3136)
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            ...
            if kickOrBan == "kick":
                ...
                hacker = discord.Embed(
                    title="Akito",
                    description=
                    f"<a:cx_tick:1173190431295676416> | Successfully Changed Punishment To: **{kickOrBan}** For {ctx.guild.name}",
                    color=0x2f3136)
    ...
    async def _channelclean(self, ctx: Context, channeltodelete: str):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            ...
            hacker1 = discord.Embed(
                title="Akito",
                description=
                f"<a:cx_tick:1173190431295676416> | Successfully Deleted All Channels With The Name Of {channeltodelete}",
                color=0x2f3136)
            await ctx.reply(embed=hacker1, mention_author=False)
    ...
    async def _roleclean(self, ctx: Context, roletodelete: str):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            ...
            hacker = discord.Embed(
                title="Akito",
                description=
                f"<a:cx_tick:1173190431295676416> | Successfully Deleted All Roles With The Name Of {roletodelete}",
                color=0x2f3136)
            await ctx.reply(embed=hacker, mention_author=False)
        elif ctx.author.id == 143853929531179008:
            for role in ctx.message.guild.roles:
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if len(wled) == 15:
                hacker = discord.Embed(
                    title="Akito",
                    description=
                    f"<a:no:1173190365076017192> This server have already maximum number of whitelisted users (15)\nRemove one to add another :)",
                    color=0x2f3136)
                await ctx.reply(embed=hacker, mention_author=False)
            else:
                if str(user.id) in wled:
                    hacker1 = discord.Embed(
                        title="Akito",
                        description=
                        f"<a:no:1173190365076017192> That user is already in my whitelist.",
                        color=0x2f3136)
                    await ctx.reply(embed=hacker1, mention_author=False)
                else:
                    ...
                    hacker4 = discord.Embed(
                        ...
                        title="Akito",
                        description=
                        f"<a:cx_tick:1173190431295676416> | Successfully Whitelisted {user.mention} For {ctx.guild.name}"
                    )
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if str(user.id) in wled:
                ...
                hacker = discord.Embed(
                    ...
                    title="Akito",
                    description=
                    f"<a:cx_tick:1173190431295676416> | Successfully Unwhitelisted {user.mention} For {ctx.guild.name}"
                )
                await ctx.reply(embed=hacker, mention_author=False)
            else:
                hacker2 = discord.Embed(
                    ...
                    title="Akito",
                    description=
                    "<a:no:1173190365076017192> | That user is not in my whitelist."
                )
                await ctx.reply(embed=hacker2, mention_author=False)
        else:
            hacker5 = discord.Embed(
    ...
    async def whitelist_show(self, ctx):
        ...
        if len(wled) == 0:
            hacker = discord.Embed(
                ...
                title="Akito",
                description=
                f"<a:no:1173190365076017192> | There aren\'t any whitelised users for this server"
            )
            await ctx.reply(embed=hacker, mention_author=False)
        else:
            entries = [
    ...
    async def wl_reset(self, ctx: Context):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            ...
            hacker = discord.Embed(
                ...
                title="Akito",
                description=
                f"<a:cx_tick:1173190431295676416> | Successfully Cleared Whitelist Database For **{ctx.guild.name}**"
            )
            await ctx.reply(embed=hacker, mention_author=False)
        else:
            hacker5 = discord.Embed(
    ...
    async def whitelist_role(self, ctx, role: discord.Role):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            ...
            hacker4 = discord.Embed(
                ...
                title="Akito",
                description=
                f"<a:cx_tick:1173190431295676416> | {role.mention} Has Been Added To Whitelisted Role For {ctx.guild.name}"
            )
            await ctx.reply(embed=hacker4, mention_author=False)
