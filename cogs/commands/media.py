...
class Media(commands.Cog):
    ...
    async def setup(self, ctx, *, channel: discord.TextChannel):
        ...
        await ctx.send(f"<:tick:1134917972079681557> | Successfully added {channel.mention} in media only channels.")
    ...
    async def remove(self, ctx, *, channel: discord.TextChannel):
        ...
        await ctx.send(f"<:tick:1134917972079681557> | Successfully removed {channel.mention} from media only channels.")
    ...
    async def reset(self, ctx):
        ...
        await ctx.send("<:tick:1134917972079681557> | Successfully removed all the media only channels.")
