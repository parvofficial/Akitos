...
class Zestar(Cog):
    ...
    async def on_message(self, message):
      button = Button(label="Invite Me", url =  "https://discord.com/api/oauth2/authorize?client_id=1173097825614180463&permissions=8&scope=bot")
      button1 = Button(label="Support Server", url = "https://discord.gg/")
      #button2 = Button(label="Vote Me", url = "https://discord.gg/6EPnbePsHW")
      try:
        ...
        with open('ignore.json', 'r') as heck:
          ...
          if message.mention_everyone:
            ...
            if str(message.channel.id) in randi["ids"]:
              ...
              embed = discord.Embed(description=f"Hey {message.author.mention}\n\nInstead of mentioning Please use the ``{prefix}help`` command\n\nIf you continue to have problems, consider asking for help [Click Here](https://discord.gg/)",color=0x0d0d13)
              view = View()
